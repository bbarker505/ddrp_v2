...
A new version of DDRP that uses modern R packages for geospatial operations, [DDRP v3](http://github.com/bbarker505/ddrp_v3), has superseded DDRP v2. The `raster` package used in DDRP v2 will not longer be updated and maintained, which may eventually lead to issues with running the script.
...
Another way to look at this (mostly) same information is with a phenological event map, below.
...
Coop, L., and B. S. Barker. 2020. Computing infrastructure requirements and user guide for hosting DDRP models. Prepared for APHIS PPQ and other collaborators. Available [here](https://github.com/bbarker505/ddrp_v2/blob/master/DDRP_user_guide_and_platform_requirements_V4.pdf).
